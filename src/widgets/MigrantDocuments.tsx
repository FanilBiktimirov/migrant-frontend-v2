    ...
    return (
        <Stack spacing={1}>
            ...
            <Stack direction="row" spacing={1} alignItems="center">
                <TextField size="small" label="DocumentType" value={documentType} onChange={(e) => setDocumentType(e.target.value)} sx={{ minWidth: 240 }} />
                <TextField size="small" label="PeriodKey (YYYY-MM)" value={periodKey} onChange={(e) => setPeriodKey(e.target.value)} sx={{ width: 180 }} />
            ...
            {uploadM.isError && <Typography color="error">Upload failed</Typography>}
            {uploadM.isSuccess && <Typography color="success.main">Uploaded</Typography>}
        </Stack>
    );
}